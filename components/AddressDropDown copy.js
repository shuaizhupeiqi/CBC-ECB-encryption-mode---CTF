...
import addressDropdownStyles from "./../styles/AddressDropdown.module.css";
...
const AddressDropdown = (props) => {
  ...
  return (
    <Row
      id={
        landscape
          ? addressDropdownStyles.addressMainContainer
          : addressDropdownStyles.addressMainContainerMobile
      }
    >
      {loading ? (
        <LoadingCard />
      ) : (
        <Row id={addressDropdownStyles.selectRow}>
          <Col span={4}>
            <Tag id={addressDropdownStyles.tagLocation}>
          ...
          <Col span={2} style={{ textAlign: "center" }}>
            <Button
              id={addressDropdownStyles.locateMeButton}
              onClick={locateMe}
            >
              {landscape ? (
